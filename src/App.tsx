  ...
  <motion.button
    ...
    animate={
      primary
        ? {
            boxShadow: [
              '0px 0px 0px rgba(0, 214, 50, 0)',
              '0px 0px 20px rgba(0, 214, 50, 0.8)',
              '0px 0px 0px rgba(0, 214, 50, 0)',
            ],
          }
        : {}
    ...
    className={`inline-block px-10 py-5 rounded-full font-bold text-white uppercase tracking-widest text-sm transition-all duration-50 shadow-xl relative overflow-hidden group text-center cursor-pointer ${
      primary
...
const SectionDivider = ({
  ...
  <div
    className={`flex items-center justify-center gap-4 py-8 rotate-180 ${className}`}
  >
    <div
      className={`h-px w-12 ${light ? 'bg-white/20' : 'bg-brand-brown/10'}`}
    />
    <Sparkles
      className={`w-4 h-4 ${light ? 'text-brand-accent/40' : 'text-brand-brown/20'}`}
    />
    <div
      className={`h-px w-12 ${light ? 'bg-white/20' : 'bg-brand-brown/10'}`}
    />
...
const CurveDivider = ({
  top = false,
  color = 'fill-brand-cream',
}: {
  top?: boolean;
  color?: string;
}) => (
  <div
    className={`absolute left-0 w-full overflow-hidden leading-0 z-20 ${top ? 'top-0' : 'bottom-0 rotate-180'}`}
  >
    <svg
      className={`relative block w-[calc(100%+1.3px)] h-10 ${color}`}
...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-brand-accent/30">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 py-20">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl leading-[1.1] mb-6">
              As receitas certas para quem está{' '}
              <span className="italic">começando</span> na confeitaria
            </h1>

            <p className="text-md md:text-lg text-white/80 mb-10 leading-relaxed max-w-2xl">
              Um manual prático com as bases que toda confeiteira iniciante
              precisa dominar para ganhar segurança, padronizar resultados e
              evitar erros que desanimam no começo.
            </p>
              ...
              <Button
                onClick={() =>
                  (window.location.href =
                    'https://payfast.greenn.com.br/147496')
                }
                primary
          ...
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="md:w-1/2">
              ...
              <div className="space-y-4 text-white/80 text-lg leading-relaxed">
                <p>
                  Quando eu comecei, também achava que precisava de dezenas de
                  receitas diferentes. Com o tempo, aprendi algo essencial:{' '}
                  <strong>quem domina as bases, domina a confeitaria.</strong>
                </p>
                <p>
                  Depois de mais de 10 anos de prática, erros, ajustes e testes,
                  eu cheguei às receitas que realmente funcionam no dia a dia —
                  aquelas que dão segurança para quem está começando.
                </p>
                <p className="text-brand-accent font-medium italic">
                  Esse manual é exatamente isso: as receitas-chave que sustentam
                  a confeitaria iniciante.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className=" text-4xl mb-6">
              O que é o Manual da Confeiteira Iniciante?
            </h2>
            <p className="text-lg text-gray-600">
              Um ebook prático com receitas base, pensadas para quem está
              começando e precisa de estabilidade, previsibilidade e segurança
              no preparo.
            </p>
          </div>
            ...
            {[
              {
                icon: ShieldCheck,
                title: 'Estabilidade',
                desc: 'Receitas que não desandam e mantêm a estrutura.',
              },
              {
                icon: TrendingUp,
                title: 'Previsibilidade',
                desc: 'Saiba exatamente o resultado que terá em cada fornada.',
              },
              {
                icon: Utensils,
                title: 'Segurança',
                desc: 'Prepare suas encomendas sem o medo de perder ingredientes.',
              },
              {
                icon: Sparkles,
                title: 'Resultados Consistentes',
                desc: 'Padronize sua produção desde o primeiro dia.',
              },
              {
                icon: BookOpen,
                title: 'Didática Prática',
                desc: 'Explicações claras e focadas em quem está começando.',
              },
              {
                icon: Target,
                title: 'Foco em Vendas',
                desc: 'Receitas testadas para aguentar o ritmo comercial.',
              },
            ].map((feature, idx) => (
              <div
                key={idx}
                className="bg-white p-8 rounded-2xl shadow-sm border border-brand-brown/30 hover:shadow-lg hover:shadow-brand-brown/20 transition-shadow"
              >
          ...
          <div className="mt-16 bg-brand-green text-white p-10 rounded-3xl">
            <h3 className="text-3xl mb-8 text-center">
              Neste manual, você terá acesso a:
            </h3>
          ...
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="md:w-2/3">
              ...
              <div className="space-y-4 text-gray-700 text-lg">
                <p>
                  Sou a Bea Requena. Confeiteira há mais de 10 anos, com ateliê
                  próprio e experiência real em produção, vendas e ensino.
                </p>
                <p>
                  As receitas deste manual fazem parte da minha prática — são
                  testadas, ajustadas e pensadas para quem está começando agora.
                </p>
              </div>
            </div>
          </div>
      ...
      <section
        id="offer"
        className="py-24 bg-brand-brown text-white relative overflow-hidden"
      >
          ...
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-16 items-center">
                  ...
                  >
                    ...
                    <div className="relative w-full h-auto rounded-[2.5rem] overflow-hidden">
                      <img
                        src="/bea-bolo.webp"
                        alt="Ebook Cover"
                        className="w-full h-full object-cover rounded-[2.5rem] border border-white"
                        referrerPolicy="no-referrer"
                      />
                      <div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/30 to-transparent flex flex-col justify-end p-8">
                        <p className="text-xs uppercase tracking-widest font-bold mb-2 text-white/70">
                          Bea Requena
                        </p>
                        <h4 className="text-2xl leading-tight text-white">
                          Manual da Confeiteira Iniciante
                        </h4>
                      ...
                      <div className="flex -space-x-2">
                        {[1, 2, 3, 4].map((i) => (
                          <img
                            ...
                            alt=""
                            className="w-8 h-8 rounded-full border-2 border-brand-brown"
                            referrerPolicy="no-referrer"
                          />
                        ))}
                      </div>
            ...
            <div className="md:w-1/2 text-center md:text-left">
              <h2 className=" text-5xl mb-6">
                Comece hoje mesmo com segurança
              </h2>
              <p className="text-xl text-white/80 mb-8">
                Se você quer começar na confeitaria com mais segurança e menos
                frustração, este manual é para você.
              </p>
              ...
              <div className="mb-10">
                <div className="flex items-center justify-center md:justify-start gap-4 mb-2">
                  ...
                  <span className="bg-brand-accent text-brand-green text-sm font-bold px-3 py-1 rounded-full">
                    60% OFF
                  </span>
                </div>
      ...
      <footer className="py-12 bg-brand-green relative text-white/40 text-center">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="text-sm">
            © {new Date().getFullYear()} Manual da Confeiteira Iniciante. Todos
